...
from utils.openai_types import ModelCard, ModelList, DeltaMessage, ChatCompletionRequest, ChatCompletionResponse, ChatCompletionResponseStreamChoice
...
async def create_chat_completion(request: ChatCompletionRequest):
    ...
    gen_kwargs = {'temperature': 0.6,
                  ...
                  'max_length': tokenizer.model_max_length if tokenizer.model_max_length < 400*1024 else 512}
    ...
    if request.stream:
        ...
        raise HTTPException(status_code=400, detail='Invalid request: Please set stream=True in the request.')
